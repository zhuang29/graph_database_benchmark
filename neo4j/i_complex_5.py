...
def run_i_complex_5(name_data, personId, minDate,num_tests):
    ...
    ofile = open("result/i_complex_5" + "_" + name_data, 'a')
    ...
    for i in range(0, num_tests):
        ...
        line = name_data + "," +  "i_complex_5," + str(i) + "," + query_param + "," + str(exe_time) + " seconds"
        print(line)
        report += line + "\n"
    report += "summary," +  name_data + "i_complex_5," + query_param + "," + str(total_time/num_tests) + " seconds"
    ofile.write(report)
    print (report)
