...
public:
  ...
  SplitEdges (string dataPath, string totalFileCount) {
    ...
    _countryVertexPath = dataPath + "country_0_0.csv";
    _universityIsLocatedInCity = dataPath + "university_isLocatedIn_city_0_0.csv";
    _companyIsLocatedInCountry = dataPath + "company_isLocatedIn_Country_0_0.csv";
    _cityIsPartOfCountry = dataPath + "city_isPartOf_country_0_0.csv";
    _countryIsPartOfContinent = dataPath + "country_isPartOf_continent_0_0.csv";
  }
