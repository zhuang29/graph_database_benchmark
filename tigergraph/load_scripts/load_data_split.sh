...
city_file="'${RAW_DATA_DIR}'/city.csv", 
country_file="'${RAW_DATA_DIR}'/country.csv", 
continent_file="'${RAW_DATA_DIR}'/continent.csv", 
...
university_isLocatedIn_city_file="'${RAW_DATA_DIR}'/university_isLocatedIn_city.csv"'

gsql -g ldbc 'run loading job load_ldbc_company_isLocatedIn_country using
company_isLocatedIn_country_file="'${RAW_DATA_DIR}'/company_isLocatedIn_country.csv"'
...
city_isPartOf_country_file="'${RAW_DATA_DIR}'/city_isPartOf_country.csv"'
